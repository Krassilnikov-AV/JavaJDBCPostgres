...
*dev - ветка требует рефакторинга!*

*dev1 - ветка, в которой находится класс DataBaseConnection с рабочим соединением соединением к БД postgresql*

Приложение должно выполнять следующии требования:
